          ...
          <div className="flex-1 space-y-6">
            {content.intro && (
              <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800 rounded-2xl p-6">
                <p className="text-emerald-800 dark:text-emerald-200 text-base leading-relaxed">{content.intro}</p>
              </div>
            )}
            ...
            {content.sections?.map((section, idx) => (
              ...
              >
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
                  <span className="flex-shrink-0 w-7 h-7 rounded-lg bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300 text-xs font-bold flex items-center justify-center">
                    {idx + 1}
                  </span>
                  {section.heading}
                </h2>
